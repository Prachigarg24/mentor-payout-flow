...
import { LayoutDashboard, CalendarDays, FileText, MessageSquare, LogOut } from 'lucide-react';
...
const MentorLayout: React.FC<MentorLayoutProps> = ({ children, title }) => {
  ...
  const menuItems = [
    ...
    { title: 'Sessions', url: '/mentor/sessions', icon: CalendarDays },
    { title: 'Receipts', url: '/mentor/receipts', icon: FileText },
    { title: 'Messages', url: '/mentor/messages', icon: MessageSquare },
  ];
